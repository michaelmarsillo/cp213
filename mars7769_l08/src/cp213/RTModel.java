...
public class RTModel {
     ...
     *
     * @param type     The name of the property to listen for.
     * @param listener The listener to attach to the model.
     */
    public void addPropertyChangeListener(final Type type, final PropertyChangeListener listener) {
     ...
     *
     * @param newBase The base value to set.
     */
     ...
     *
     * @param newHeight The height value to set.
     */
    ...
    /**
     * Sets the value of the hypotenuse. (Private because the hypotenuse cannot be
     * changed independently of the base or height.)
     */
